    ...
    if args.dry_run:
        ...
        if hakemler and gonderilen == 0:
            ...
            log("     Genellikle MAIL_FROM doğrulanmamış alan adında olur "
                "(Resend 403). Düzeltip hakem linklerini elle iletin: "
                "python db.py --reviewers")
        ...
        if hakemler or RAPOR_ALICI:
            ...
            # alıcı sayısını basıyordu; Resend 403 dönse bile "3 kişiye
            # gönderildi" yazıyordu. Sessiz hatayı gizleyen tam da buydu.
            rapor_ok = emails.rapor_gonder(
                rapor_alicilari,
                f"Nükleer Enerji Bülteni — Sayı {sayi_no} taslak hazır", govde)
