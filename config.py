...
# ============================================================
AYARLAR = {
    # Takvim: taslak Pazar 13:00 TSİ hazırlanır, yayın Pazartesi 08:00 TSİ.
    # Render cron (UTC): taslak "0 10 * * 0" · yayın "0 5 * * 1"
    # ⚠ 13:00, diğer iki bültenle (biyoekonomi 12:00, yarı iletken 12:30)
    # aynı Anthropic/Exa anahtarını paylaştığı için bilinçli seçildi —
