...
# ============================================================
SAHTE_ADAYLAR = [
    {"id": "t1", "title": "NRC certifies new 300 MWe small modular reactor design",
     "domain": "world-nuclear-news.org", "published_date": "2026-09-18",
     "snippet": ("The US Nuclear Regulatory Commission issued a standard "
                 "design approval for a 300 MWe light-water small modular "
                 "reactor, clearing the way for construction permit "
                 "applications at two candidate sites.")},
    {"id": "t2", "title": "EU approves 2.4 billion euro for nuclear new build financing",
     "domain": "ec.europa.eu", "published_date": "2026-09-17",
     "snippet": ("The European Commission approved a state aid scheme worth "
                 "2.4 billion euro supporting the construction of two large "
                 "reactors, with a contract-for-difference term of 35 years.")},
    {"id": "t3", "title": "Streaming series about a nuclear submarine tops charts",
     "domain": "example-entertainment.com", "published_date": "2026-09-16",
     "snippet": ("A drama series set aboard a submarine became the most "
                 "watched show of the week.")},   # REDDEDİLMELİ
]
...
# ============================================================
SAHTE_DERIN = [{
    "event_key": "ab-nukleer-yeni-insa-devlet-yardimi",
    "kategori": "politika",
    "puan": 86,
    "olgunluk": "funded",
    "baslik_ozet": "AB, iki büyük reaktör için 2,4 milyar euroluk destek şemasını onayladı",
    "sirketler": [],
    "ulkeler": ["AB"],
    "kaynaklar": [{
        "name": "European Commission", "domain": "ec.europa.eu",
        "url": "https://ec.europa.eu/example-nuclear-state-aid",
        "published_date": "2026-09-17", "primary": True, "paywall": False,
        "text": ("The European Commission approved on 17 September 2026 a "
                 "state aid scheme worth 2.4 billion euro to support the "
                 "construction of two large light-water reactors with a "
                 "combined capacity of 2,400 MWe. The support takes the form "
                 "of a contract for difference with a term of 35 years and a "
                 "strike price of 92 euro per MWh in 2026 prices, indexed to "
                 "inflation. Construction is expected to start in 2029 with "
                 "grid connection planned for 2037 and 2039. The Commission "
                 "estimates the projects will create 4,500 construction jobs "
                 "and 900 permanent operating positions."),
    }],
}]

SAHTE_RADAR = [
    {"event_key": "smr-tasarim-onayi", "kategori": "smr",
     "baslik_ozet": "NRC, 300 MWe küçük modüler reaktör tasarımını onayladı",
     "kaynaklar": [{"name": "World Nuclear News",
                    "domain": "world-nuclear-news.org",
                    "url": "https://world-nuclear-news.org/example-smr",
                    "published_date": "2026-09-18", "primary": True}]},
    {"event_key": "yakit-tedarik-anlasmasi", "kategori": "yakit",
     "baslik_ozet": "Avrupalı işletmeci ile uzun vadeli zenginleştirilmiş uranyum anlaşması",
     "kaynaklar": [{"name": "Reuters", "domain": "reuters.com",
                    "url": "https://reuters.com/example-uranium",
...
def test_yazim(model):
    ...
    sonuc("story id = event_key", "ab-nukleer-yeni-insa-devlet-yardimi" in idler,
